...
<body>
  <div class="bg-dark py-3">
    <h3 class="text-white text-center">Add new product</h3>
  </div>
      ...
      <div class="col-md-10">
        <div class="card border-0 shadow-lg my-4">
          <div class="card-header bg-dark py-3 d-flex justify-content-between align-items-center">
            <h2 class="text-white" style="padding-left: 20px;">Create Product</h2>
            ...
            <form enctype="multipart/form-data" action="{{route('products.store')}}" method="POST" enctype="multipart/form-data">
              ...
              <div class="card-body">
                <div class="mb-3">
                  ...
                  <input value="{{old('product')}}" type="text" class="@error('product') is-invalid @enderror form-control form-control-lg" placeholder="product" name="product">
                  @error('product')
                ...
                <div class="mb-3">
                  ...
                  <input value="{{old('category')}}" type="text" class="@error('category') is-invalid @enderror form-control form-control-lg" placeholder="category" name="category">
                  @error('category')
                  <p class="invalid-feedback">{{$message}}</p>
                  @enderror
                </div>
                ...
                <div class="mb-3">
                  ...
                  <textarea placeholder="Product description" name="description" class="form-control" cols="30" rows="5">{{old('description')}}</textarea>
                </div>
                <div class="mb-3">
